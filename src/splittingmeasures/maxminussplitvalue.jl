function calculateSplitValue(a::MaxMinusValueSplit,labellist::Array{UInt8,1},sumnumerator::Array{Float64,1},sumdenominator::Array{Float64,1},sumweight::Array{Float64,1},countlistfloat::Array{Float64,1},minweight::Float64,subs::DTSubsets)
#here randomweight==0
...
function calculateSplitValue(a::MaxMinusValueSplit,labels::Array{Float64,1}, labels_orig::Array{Float64,1}, labels_new::Array{Float64,1}, features::PooledArray,subset::Array{UInt8,1},minweight::Float64,prem_buffer::Int, moderationfactor::Float64)
  suml=sumr=0.0
  countl=countr=0
