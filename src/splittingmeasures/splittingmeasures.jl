...
include("splitting_measures_maxsplitvalue.jl")
include("splitting_measures_maxabssplitvalue.jl")
include("splitting_measures_maxminussplitvalue.jl")
include("splitting_measures_ROptMinRLost.jl")
include("splitting_measures_ROptMinRLostPct.jl")
#include("splitting_measures_mse.jl")
include("splitting_measures_rankopt.jl")
...
#end #end module DTSplitMeasures
