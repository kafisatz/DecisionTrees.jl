...
function calculateSplitValue(a::MaxValueSplit,labels::Array{Float64,1}, labels_orig::Array{Float64,1}, labels_new::Array{Float64,1}, features::pdaMod,subset::Array{UInt8,1},minweight::Float64,prem_buffer::Int, moderationfactor::Float64)
  suml=sumr=0.0
  countl=countr=0
