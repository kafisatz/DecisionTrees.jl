...
@time df_tmp=CSV.read(string("data\\data1small.csv"),allowmissing=:none,categorical=false,rows_for_type_detect=10000);
...
dtmtable,sett=prepare_dataframe_for_dtm!(df_tmp,"C:\\temp\\",treat_as_categorical_variable=["PLZ_WOHNORT"],weightcol="EXPOSURE",numcol="LOSS20HALF",denomcol="PREMIUM66",independent_vars=selected_explanatory_vars);
dtm(dtmtable,sett)
sett.minw=-.2